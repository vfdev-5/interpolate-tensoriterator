    ...
    at::IntArrayRef output_size)
{
    ...
    std::cout << "- get_strides : " << iter.get_strides() << std::endl;
    std::cout << "- strides per arg : " << std::endl;
    for (int arg=0; arg < iter.ntensors(); arg++)
    {
        std::cout << "-- " << arg << " : " << iter.strides(arg) << std::endl;
    }

    std::cout << "- ndim : " << iter.ndim() << std::endl;
    std::cout << "- numel : " << iter.numel() << std::endl;
    std::cout << "- shape : " << iter.shape() << std::endl;
    std::cout << "- ntensors : " << iter.ntensors() << std::endl;
