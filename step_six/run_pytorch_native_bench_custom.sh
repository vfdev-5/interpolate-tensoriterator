...
filepath1="custom_pth_nightly_results_$version1.log.save$postfix"
pickle_filepath1="custom_pth_nightly_results_$version1$postfix"

echo "" > $filepath1
export OMP_NUM_THREADS=6 
PYTHONPATH=$MASTER_TORCH_PATH python -u run_pytorch_native_bench.py $pickle_filepath1.$OMP_NUM_THREADS.pickle $min_run_time 1 1 --custom $custom_tests >> $filepath1
...
filepath2="custom_pr_results_$version2.log.save$postfix"
pickle_filepath2="custom_pr_results_$version2$postfix"
echo $filepath2

echo "" > $filepath2
export OMP_NUM_THREADS=6 
PYTHONPATH=$PR_TORCH_PATH python -u run_pytorch_native_bench.py $pickle_filepath2.$OMP_NUM_THREADS.pickle $min_run_time 1 1 --custom $custom_tests >> $filepath2
...
output="custom_pr_${version2}_vs_pth_${version1}_results${postfix}.md"
rm -rf $output
