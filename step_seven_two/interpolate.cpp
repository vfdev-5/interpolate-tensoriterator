...
void _upsample_nearest2d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_h,
...
Tensor upsample_nearest2d_cpu(
  ...
  _upsample_nearest2d_kernel_impl(output, input, false, scale_h, scale_w);
  return output;
}


void _upsample_bilinear2d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_h,
...
Tensor upsample_bilinear2d_cpu(
  ...
  output.resize_(full_output_size, input.suggest_memory_format());
  _upsample_bilinear2d_kernel_impl(output, input, align_corners, scale_h, scale_w);
  return output;
}


void _upsample_bicubic2d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_h,
...
Tensor upsample_bicubic2d_cpu(
  ...
  output.resize_(full_output_size, input.suggest_memory_format());
  _upsample_bicubic2d_kernel_impl(output, input, align_corners, scale_h, scale_w);
  return output;
}


void _upsample_nearest1d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_w) {
...
Tensor upsample_nearest1d_cpu(
  ...
  _upsample_nearest1d_kernel_impl(output, input, false, scale_w);
  return output;
}


void _upsample_linear1d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_w) {
...
Tensor upsample_linear1d_cpu(
  ...
  output.resize_(full_output_size);
  _upsample_linear1d_kernel_impl(output, input, align_corners, scale_w);
  return output;
}


void _upsample_nearest3d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_d,
...
Tensor upsample_nearest3d_cpu(
  ...
  output.resize_(full_output_size, input.suggest_memory_format());
  _upsample_nearest3d_kernel_impl(output, input, false, scale_d, scale_h, scale_w);
  return output;
}


void _upsample_trilinear3d_kernel_impl(
    Tensor& output,
    const Tensor& input,
    bool align_corners,
    c10::optional<double> scales_d,
...
Tensor upsample_trilinear3d_cpu(
  ...
  output.resize_(full_output_size, input.suggest_memory_format());
  _upsample_trilinear3d_kernel_impl(output, input, align_corners, scale_d, scale_h, scale_w);
  return output;
}


} // anonymous ti_upsample
} // namespace native
} // namespace at
